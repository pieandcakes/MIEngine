...
namespace Microsoft.SSHDebugPS.Docker
{
    ...
    internal class DockerExecSettings : DockerContainerTransportSettings
    {
        ...
        public DockerExecSettings(DockerContainerTransportSettings settings, string command, bool makeInteractive = true)
            : base(settings)
        {
        ...
        protected override string SubCommandArgs => (_makeInteractive ? _interactiveFlag : string.Empty) + _subCommandArgsFormat.FormatInvariantWithArgs(ContainerName, _commandToExecute);
    }
